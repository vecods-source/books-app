...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"userid" | "username" | "email" | "password" | "profileImage" | "createdAt", ExtArgs["result"]["user"]>
  ...
  export type booksOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"bookid" | "title" | "authorId" | "caption" | "image" | "createdAt", ExtArgs["result"]["books"]>
  ...
  export interface booksDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> {
     ...
     * const booksWithBookidOnly = await prisma.books.createManyAndReturn({
     *   select: { bookid: true },
     *   data: [
     *     // ... provide data here
     *   ]
     ...
     * const booksWithBookidOnly = await prisma.books.updateManyAndReturn({
     *   select: { bookid: true },
     *   where: {
     *     // ... provide filter here
     *   },
  ...
  interface booksFieldRefs {
    readonly bookid: FieldRef<"books", 'String'>
    readonly title: FieldRef<"books", 'String'>
    readonly authorId: FieldRef<"books", 'String'>
    readonly caption: FieldRef<"books", 'String'>
  ...
  export type booksWhereInput = {
    ...
    bookid?: StringFilter<"books"> | string
    title?: StringFilter<"books"> | string
    authorId?: StringFilter<"books"> | string
    caption?: StringFilter<"books"> | string
  ...
  export type booksScalarWhereWithAggregatesInput = {
    ...
    bookid?: StringWithAggregatesFilter<"books"> | string
    title?: StringWithAggregatesFilter<"books"> | string
    authorId?: StringWithAggregatesFilter<"books"> | string
    caption?: StringWithAggregatesFilter<"books"> | string
